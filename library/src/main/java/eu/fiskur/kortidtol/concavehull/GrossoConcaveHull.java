...
import eu.fiskur.kortidtol.concavehull.triangulation.DoubleComparator;
import eu.fiskur.kortidtol.concavehull.triangulation.model.Edge;
import eu.fiskur.kortidtol.concavehull.triangulation.model.Triangle;
import eu.fiskur.kortidtol.concavehull.triangulation.model.Vertex;
...
public class GrossoConcaveHull {
   ...
   * @param threshold
   */
  public GrossoConcaveHull(Geometry geometry, double threshold) {
   ...
   * @param threshold
   */
  public GrossoConcaveHull(GeometryCollection geometries, double threshold) {
